...
import com.gharbia.medical.databinding.ActivityItemResultXrayBinding;
import com.gharbia.medical.viewModel.ItemResultXRayViewModel;

import java.util.ArrayList;
import java.util.List;

public class ItemResultXRayActivity extends BaseActivity implements AddressClick {

    public ActivityItemResultXrayBinding binding;
    ItemResultXRayViewModel viewModel;
    public int clinicId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_result_xray);
        addressModelsMaster = new ArrayList<>();
        clinicId = getIntent().getIntExtra("id",0);
        binding = DataBindingUtil.setContentView(this,R.layout.activity_item_result_xray);
        viewModel = new ItemResultXRayViewModel(this);
    ...
    public void initRecycler(List<DepartmentsDataModel> departmentsResponse){
        departmentsAdapter = new DepartmentsAdapter(ItemResultXRayActivity.this,departmentsResponse,0);
