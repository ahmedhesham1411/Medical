...
import com.gharbia.medical.Adapter.PhamaciesResultAdapter;
...
import com.gharbia.medical.databinding.ActivityPharmaciesBinding;
import com.gharbia.medical.viewModel.PharmaciesViewModel;

import java.util.ArrayList;
import java.util.List;

public class PharmaciesActivity extends BaseActivity implements SortClick, SheetClick {

    ActivityPharmaciesBinding binding;
    PharmaciesViewModel viewModel;
    PhamaciesResultAdapter adapter;
    public int line=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_pharmacies);
        viewModel = new PharmaciesViewModel(this);
    ...
    private void initRecycler() {
        adapter = new PhamaciesResultAdapter(this,hospitalsData,this);
