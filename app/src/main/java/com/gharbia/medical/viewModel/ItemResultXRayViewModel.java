...
public class ItemResultXRayViewModel extends ViewModel {

    @SuppressLint("StaticFieldLeak")
    ItemResultXRayActivity activity;
    ...
    public ItemResultXRayViewModel(ItemResultXRayActivity activity) {
    ...
    public void GetDetails() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofitNoHeaderMultiPart()
                .GetXRayDetails(activity.clinicId,Locale.getDefault().getLanguage())
