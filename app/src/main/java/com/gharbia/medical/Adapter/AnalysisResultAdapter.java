...
public class AnalysisResultAdapter extends RecyclerView.Adapter<AnalysisResultAdapter.ViewHolder> {
    ...
    public AnalysisResultAdapter(Activity activity, List<HospitalsResponse.HospitalsData> hospitalsData, SortClick sortClick) {
...
/*        RecyclerInsideAdapter adapter = new RecyclerInsideAdapter(activity,hospitalsData.get(position).getAddresses());
        ...
        holder.itemView.setOnClickListener(view -> {
            Intent intent = new Intent(activity, ItemResultAnalysisActivity.class);
