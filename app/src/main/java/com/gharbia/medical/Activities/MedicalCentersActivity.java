...
import com.gharbia.medical.Adapter.MedicalCentersResultAdapter;
...
import com.gharbia.medical.databinding.ActivityMedicalCentersBinding;
import com.gharbia.medical.viewModel.MedicalCentersViewModel;

import java.util.ArrayList;
import java.util.List;

public class MedicalCentersActivity extends BaseActivity implements SortClick, SheetClick {

    ActivityMedicalCentersBinding binding;
    MedicalCentersViewModel viewModel;
    MedicalCentersResultAdapter adapter;
    public int line=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_medical_centers);
        viewModel = new MedicalCentersViewModel(this);
    ...
    private void initRecycler() {
        adapter = new MedicalCentersResultAdapter(this,hospitalsData,this);
