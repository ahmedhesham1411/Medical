...
public class ItemResultPharmaciesViewModel extends ViewModel {

    @SuppressLint("StaticFieldLeak")
    ItemResultPharmaciesActivity activity;
    ...
    public ItemResultPharmaciesViewModel(ItemResultPharmaciesActivity activity) {
    ...
    public void GetDetails() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofitNoHeaderMultiPart()
                .GetPharmacyDetails(activity.clinicId,Locale.getDefault().getLanguage())
