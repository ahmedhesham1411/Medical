...
public class AnalysisViewModel extends ViewModel {
    ...
    List<HospitalsResponse.HospitalsData> data;

    public AnalysisViewModel(AnalysisActivity activity) {
    ...
    public void GetAnalysis() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofitByToken(Preferences.GetToken(activity))
                .GetAnalysis(Locale.getDefault().getLanguage(),activity.pageIndex,Integer.parseInt(Preferences.GetCityId(activity)),true)
    ...
    private void handleResponse(HospitalsResponse hospitalsResponse) {
        //alertDialog.dismiss();
        data.addAll(hospitalsResponse.getData());
        GetHospitals2();
    }
    ...
    public void GetHospitals2() {
        //showLoadingDialog(activity);
        mSubscriptions.add(NetworkUtil.getRetrofitByToken(Preferences.GetToken(activity))
                .GetAnalysis(Locale.getDefault().getLanguage(),activity.pageIndex,Integer.parseInt(Preferences.GetCityId(activity)),false)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
