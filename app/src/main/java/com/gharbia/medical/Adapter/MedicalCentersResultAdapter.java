...
public class MedicalCentersResultAdapter extends RecyclerView.Adapter<MedicalCentersResultAdapter.ViewHolder> {

    Activity activity;
    SortClick sortClick;
    List<HospitalsResponse.HospitalsData> hospitalsData;

    public MedicalCentersResultAdapter(Activity activity, List<HospitalsResponse.HospitalsData> hospitalsData, SortClick sortClick) {
...
/*        RecyclerInsideAdapter adapter = new RecyclerInsideAdapter(activity,hospitalsData.get(position).getAddresses());
        ...
        holder.itemView.setOnClickListener(view -> {
            Intent intent = new Intent(activity, ItemResultMedicalCentersActivity.class);
