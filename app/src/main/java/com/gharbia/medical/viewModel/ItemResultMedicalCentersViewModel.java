...
import com.gharbia.medical.Activities.ItemResultMedicalCentersActivity;
...
public class ItemResultMedicalCentersViewModel extends ViewModel {

    @SuppressLint("StaticFieldLeak")
    ItemResultMedicalCentersActivity activity;
    SliderItemAdapter adapter;
    public ObservableField<Boolean> isReviews = new ObservableField<>(false);
    AlertDialog alertDialog;
    private final CompositeSubscription mSubscriptions = new CompositeSubscription();
    public String faceBook,youTube,whatsApp,instagram,webSite,whatsappNumber,phone,phone2,img;

    public ItemResultMedicalCentersViewModel(ItemResultMedicalCentersActivity activity) {
    ...
    public void GetDetails() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofitNoHeaderMultiPart()
                .GetMedicalCenterDetails(activity.clinicId,Locale.getDefault().getLanguage())
