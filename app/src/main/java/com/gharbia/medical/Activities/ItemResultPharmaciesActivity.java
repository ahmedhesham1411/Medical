...
import com.gharbia.medical.databinding.ActivityItemResultPharmaciesBinding;
import com.gharbia.medical.viewModel.ItemResultPharmaciesViewModel;

import java.util.ArrayList;
import java.util.List;

public class ItemResultPharmaciesActivity extends BaseActivity implements AddressClick {

    public ActivityItemResultPharmaciesBinding binding;
    ItemResultPharmaciesViewModel viewModel;
    public int clinicId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_result_pharmacies);
        addressModelsMaster = new ArrayList<>();
        clinicId = getIntent().getIntExtra("id",0);
        binding = DataBindingUtil.setContentView(this,R.layout.activity_item_result_pharmacies);
        viewModel = new ItemResultPharmaciesViewModel(this);
    ...
    public void initRecycler(List<DepartmentsDataModel> departmentsResponse){
        departmentsAdapter = new DepartmentsAdapter(ItemResultPharmaciesActivity.this,departmentsResponse,0);
