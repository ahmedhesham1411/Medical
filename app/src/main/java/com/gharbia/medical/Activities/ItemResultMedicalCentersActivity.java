...
import com.gharbia.medical.databinding.ActivityItemResultMedicalCentersBinding;
import com.gharbia.medical.viewModel.ItemResultMedicalCentersViewModel;

import java.util.ArrayList;
import java.util.List;

public class ItemResultMedicalCentersActivity extends BaseActivity implements AddressClick, AClick {

    public ActivityItemResultMedicalCentersBinding binding;
    ItemResultMedicalCentersViewModel viewModel;
    public int clinicId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_result_medical_centers);
        addressModelsMaster = new ArrayList<>();
        clinicId = getIntent().getIntExtra("id",0);
        binding = DataBindingUtil.setContentView(this,R.layout.activity_item_result_medical_centers);
        viewModel = new ItemResultMedicalCentersViewModel(this);
    ...
    public void initRecycler(List<DepartmentsDataModel> departmentsResponse){
        departmentsAdapter = new Departments2Adapter(ItemResultMedicalCentersActivity.this,departmentsResponse,0,this);
