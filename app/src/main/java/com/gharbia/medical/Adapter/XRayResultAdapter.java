...
import com.gharbia.medical.Activities.ItemResultXRayActivity;
...
public class XRayResultAdapter extends RecyclerView.Adapter<XRayResultAdapter.ViewHolder> {

    Activity activity;
    SortClick sortClick;
    List<HospitalsResponse.HospitalsData> hospitalsData;

    public XRayResultAdapter(Activity activity, List<HospitalsResponse.HospitalsData> hospitalsData, SortClick sortClick) {
...
/*        RecyclerInsideAdapter adapter = new RecyclerInsideAdapter(activity,hospitalsData.get(position).getAddresses());
        ...
        holder.itemView.setOnClickListener(view -> {
            Intent intent = new Intent(activity, ItemResultXRayActivity.class);
