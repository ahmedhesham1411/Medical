...
public class CurrentAppointmentsViewModel extends ViewModel {

    CurrentAppointmentsFragment fragment;
    @SuppressLint("StaticFieldLeak")
    Activity activity;
    private CompositeSubscription mSubscriptions = new CompositeSubscription();
    AlertDialog alertDialog;

    public CurrentAppointmentsViewModel(CurrentAppointmentsFragment fragment) {
    ...
    public void GetDetails() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofitByToken(Preferences.GetToken(activity))
                .GetCurrentAppointments(Locale.getDefault().getLanguage())
