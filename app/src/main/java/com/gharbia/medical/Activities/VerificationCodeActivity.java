...
import com.gharbia.medical.viewModel.VerificationCodeViewModel;
import com.gharbia.medical.databinding.ActivityVerificationCodeBinding;
...
public class VerificationCodeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new VerificationCodeViewModel(this);
        ...
        binding.num4Edt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                Constant.hideKeyboard(VerificationCodeActivity.this);
            }
        });
    }
