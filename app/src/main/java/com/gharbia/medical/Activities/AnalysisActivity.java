...
import com.gharbia.medical.Adapter.AnalysisResultAdapter;
...
import com.gharbia.medical.databinding.ActivityAnalysisBinding;
import com.gharbia.medical.viewModel.AnalysisViewModel;

import java.util.ArrayList;
import java.util.List;

public class AnalysisActivity extends BaseActivity implements SortClick, SheetClick {

    ActivityAnalysisBinding binding;
    AnalysisViewModel viewModel;
    AnalysisResultAdapter adapter;
    public int line=0;
    ...
    private void initRecycler() {
        adapter = new AnalysisResultAdapter(this,hospitalsData,this);
