...
public class XRayViewModel extends ViewModel {

    @SuppressLint("StaticFieldLeak")
    XRayActivity activity;
    ...
    public XRayViewModel(XRayActivity activity) {
    ...
    public void GetXRay() {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofitByToken(Preferences.GetToken(activity))
                .GetXRay(Locale.getDefault().getLanguage(),activity.pageIndex,Integer.parseInt(Preferences.GetCityId(activity)),true)
    ...
    public void GetHospitals2() {
        //showLoadingDialog(activity);
        mSubscriptions.add(NetworkUtil.getRetrofitByToken(Preferences.GetToken(activity))
                .GetXRay(Locale.getDefault().getLanguage(),activity.pageIndex,Integer.parseInt(Preferences.GetCityId(activity)),false)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
