...
public class HospitalResultAdapter extends RecyclerView.Adapter<HospitalResultAdapter.ViewHolder> {

    Activity activity;
    SortClick sortClick;
    List<HospitalsResponse.HospitalsData> hospitalsData;

    public HospitalResultAdapter(Activity activity, List<HospitalsResponse.HospitalsData> hospitalsData, SortClick sortClick) {
...
/*        RecyclerInsideAdapter adapter = new RecyclerInsideAdapter(activity,hospitalsData.get(position).getAddresses());
        ...
        holder.itemView.setOnClickListener(view -> {
            Intent intent = new Intent(activity, ItemResultHospitalActivity.class);
